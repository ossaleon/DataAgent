# Test 03: Max Tokens Agent Ladder
...
```text
models x repeats x 12 token configs x 10 prompts
```
...
```text
gemma4:e4b             evaluation/thesis_test03_gemma4_max_tokens.yaml
gemma4:26b             evaluation/thesis_test03_gemma4_max_tokens.yaml
nemotron-3-nano:4b     evaluation/thesis_test03_nemotron3_nano_max_tokens.yaml
mistral-small3.2:24b   evaluation/thesis_test03_mistral_small32_max_tokens.yaml
```
...
for REP in 01 02; do
  docker run --rm --gpus '"device=0"' --network=host \
    ...
    evaluation/thesis_test03_gemma4_max_tokens.yaml \
    --provider ollama \
    --model gemma4:e4b \
    --judge-provider ollama \
    --judge-model gemma4:e4b \
    --save-dir runs/thesis_tests/03_max_tokens_agent_ladder/gemma4_e4b/rep${REP} \
    --resume
  ...
  docker run --rm --gpus '"device=0"' --network=host \
    ...
    --save-dir runs/thesis_tests/03_max_tokens_agent_ladder/gemma4_26b/rep${REP} \
    --resume
  ...
  docker run --rm --gpus '"device=0"' --network=host \
    ...
    evaluation/run_manifest_benchmark.py \
    evaluation/benchmark_dataset_gemma4_thesis_10.json \
    evaluation/thesis_test03_nemotron3_nano_max_tokens.yaml \
    --provider ollama \
    --model nemotron-3-nano:4b \
    --judge-provider ollama \
    --judge-model nemotron-3-nano:4b \
    --save-dir runs/thesis_tests/03_max_tokens_agent_ladder/nemotron3_nano_4b/rep${REP} \
    --resume
  ...
  docker run --rm --gpus '"device=0"' --network=host \
    ...
    evaluation/run_manifest_benchmark.py \
    evaluation/benchmark_dataset_gemma4_thesis_10.json \
    evaluation/thesis_test03_mistral_small32_max_tokens.yaml \
    --provider ollama \
    --model mistral-small3.2:24b \
    --judge-provider ollama \
    --judge-model mistral-small3.2:24b \
    --save-dir runs/thesis_tests/03_max_tokens_agent_ladder/mistral_small32_24b/rep${REP} \
    --resume
done
```
