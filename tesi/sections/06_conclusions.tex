...
LLM system \textbf{XXX I would say "multi-step LLM data agent" because your thesis contains one graph-based agent with several steps, not several autonomous agents XXX} for sales-data analysis. This chapter summarises the findings with respect to the five research questions introduced in Section 1. The central result is that model choice
