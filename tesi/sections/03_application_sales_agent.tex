...
visualisation. The section then explains the LLM integration and prompting
...
(3)~\texttt{end} is selected when both the textual analysis and the visualisation answers
