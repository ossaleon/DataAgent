...
\textcolor{red}{The SQL generation prompt deliberately omits the CoT reasoning section.
During development, we observed that smaller open-weight models tended to lose track
