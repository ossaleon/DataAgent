...
\newcommand{\firstcoadvisor}{Hamta Sedghani} % insert if any otherwise comment
...
\begin{figure}[t]
    ...
    \caption{Test~02: best prompt E2E quality delta per (step, parameter) pair for all runs.}
